		...
		<div class="offset-md-2 col-md-4">
			<div class="card" style="width:200%;">
				<div class="card-header text-white" style="background: #9fd6ba;">
					<h2><span style="color: gray;"></span>회원가입</h2>
				</div>
				<div class="card-body">
...
$(function() {
	...
	//(chk1 : 이메일검증, chk2 : 비밀번호, chk3: 비번확인란, chk4: 닉네임, chk5: 핸드폰 번호, chk6: 계좌번호)
	...
	//chk6: 계좌번호
	$('#user_bankAccount').on('keyup', function() {
		
		if($("#user_bankAccount").val() == ""){
		    $('#user_bankAccount').css("background-color", "blue");
			$('#bankAccountChk').html('<b style="font-size:16px;color:red;">[휴대폰 번호를 입력해주세요.]</b>');
			chk6 = false;
		} else {
